    ...
    */
    ...
    public void DecompressBitplane()
    {
        ...
        while (totalBytes < tileWidth * height)
        {
            if (groupType == 0)
            {
                //check if the first data group is an RLE or normal data group
                //RLE group
                ...
                */
                ...
                {
                    //add bitsToAdd zeros to the decompressed data
                    WriteBitPair(0, 0);
            ...
            else
            {
                ...
                while (bit1 != 0 || bit2 != 0)
                {
                    //keep going until the current pair is 00
    ...
    public void CenterSprite()
    {
        ...
        for (int x = 0; x < tileWidth; x++)
        {
            ...
            {
                Array.Copy(combinedSpriteData, 16 * (x * tileHeight + y), newArray,
                    16 * (7 * (x + startXPos) + y + startYPos), 16);
            }
        }
    ...
    public Color[] palette =
        { Color.white, new Color(0.66f, 0.66f, 0.66f), new Color(0.33f, 0.33f, 0.33f), Color.black };
